...
screen item_description(selling=False):
    frame xysize 1200, 56:
        ...
        if selected_item is not None:
            ...
            text _("Click on an item to read its description.") offset (14,6) color "#8b8b8b"
...
screen inventory(collection, selling=False):
    ...
    textbutton _("Return") action Jump("start2") style "offset_return_button" yalign .98

    if start3:

        textbutton _("Return") action Jump("start3") style "offset_return_button" yalign .98

    if start4:

        textbutton _("Return") action Jump("start4") style "offset_return_button" yalign .98

    if start5:

        textbutton _("Return") action Jump("test_menu2") style "offset_return_button" yalign .98

    if start6:

        textbutton _("Return") action Jump("start6") style "offset_return_button" yalign .98
