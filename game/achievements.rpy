...
define Not_slaying_the_princess = Achievement(
    ## The human-readable name, as it'll appear in the popup and in the gallery.
    name=_("Not slaying the princess (Bronze)"),
    ## The id is used for Steam integration, and should match whatever ID
    ## you have set up in the Steam backend (if using).
    id="Not_slaying_the_princess",
    ## Description.
    description=_("Didn't take the knife."),
    ## The image used in the popup and in the gallery once this achievement
    ## is unlocked.
    unlocked_image="gui/window_icon.png",
    ## By default all achievements use the "locked_achievement" image (declared
...
define Lyra_Thorsdottir = Achievement(
    ## The human-readable name, as it'll appear in the popup and in the gallery.
    name=_("Lyra Thorsdottir (Silver)"),
    ## The id is used for Steam integration, and should match whatever ID
    ## you have set up in the Steam backend (if using).
    id="Lyra_Thorsdottir",
    ## Description.
    description=_("Demolish an enemy with Keraunos."),
    ## The image used in the popup and in the gallery once this achievement
    ## is unlocked.
    unlocked_image="gui/window_icon.png",
    ## By default all achievements use the "locked_achievement" image (declared
...
define Nonmetal_alchemist = Achievement(
    ## The human-readable name, as it'll appear in the popup and in the gallery.
    name=_("Nonmetal Alchemist (Bronze)"),
    ## The id is used for Steam integration, and should match whatever ID
    ## you have set up in the Steam backend (if using).
    id="Nonmetal_alchemist",
    ## Description.
    description=_("Trigger Toxic Blaze."),
    ## The image used in the popup and in the gallery once this achievement
    ## is unlocked.
    unlocked_image="gui/window_icon.png",
    ## By default all achievements use the "locked_achievement" image (declared
...
define Last_Resort = Achievement(
    ## The human-readable name, as it'll appear in the popup and in the gallery.
    name=_("Last Resort (Silver)"),
    ## The id is used for Steam integration, and should match whatever ID
    ## you have set up in the Steam backend (if using).
    id="Last_Resort",
    ## Description.
    description=_("Execute Muramasa: Oblivion Hunt."),
    ## The image used in the popup and in the gallery once this achievement
    ## is unlocked.
    unlocked_image="gui/window_icon.png",
    ## By default all achievements use the "locked_achievement" image (declared
...
define I_am_only_human_after_all = Achievement(
    ## The human-readable name, as it'll appear in the popup and in the gallery.
    name=_("I am only human after all (Bronze)"),
    ## The id is used for Steam integration, and should match whatever ID
    ## you have set up in the Steam backend (if using).
    id="I_am_only_human_after_all",
    ## Description.
    description=_("Doubt your adventure."),
    ## The image used in the popup and in the gallery once this achievement
    ## is unlocked.
    unlocked_image="gui/window_icon.png",
    ## By default all achievements use the "locked_achievement" image (declared
...
define No_rest_for_the_weary = Achievement(
    ## The human-readable name, as it'll appear in the popup and in the gallery.
    name=_("No rest for the weary (Bronze)"),
    ## The id is used for Steam integration, and should match whatever ID
    ## you have set up in the Steam backend (if using).
    id="No_rest_for_the_weary",
    ## Description.
    description=_("Unlocked Ending A."),
    ## The image used in the popup and in the gallery once this achievement
    ## is unlocked.
    unlocked_image="gui/window_icon.png",
    ## By default all achievements use the "locked_achievement" image (declared
...
define Vacay_for_Red_Gaze = Achievement(
    ## The human-readable name, as it'll appear in the popup and in the gallery.
    name=_("Vacay for Red Gaze (Bronze)"),
    ## The id is used for Steam integration, and should match whatever ID
    ## you have set up in the Steam backend (if using).
    id="Vacay_for_Red_Gaze",
    ## Description.
    description=_("Unlocked Ending B."),
    ## The image used in the popup and in the gallery once this achievement
    ## is unlocked.
    unlocked_image="gui/window_icon.png",
    ## By default all achievements use the "locked_achievement" image (declared
...
define Red_Saint = Achievement(
    ## The human-readable name, as it'll appear in the popup and in the gallery.
    name=_("Red Saint (Silver)"),
    ## The id is used for Steam integration, and should match whatever ID
    ## you have set up in the Steam backend (if using).
    id="not_slaying_the_princess",
    ## Description.
    description=_("Unlocked Ending C."),
    ## The image used in the popup and in the gallery once this achievement
    ## is unlocked.
    unlocked_image="gui/window_icon.png",
    ## By default all achievements use the "locked_achievement" image (declared
...
define Shard_hunter = Achievement(
    ## The human-readable name, as it'll appear in the popup and in the gallery.
    name=_("Shard hunter (Silver)"),
    ## The id is used for Steam integration, and should match whatever ID
    ## you have set up in the Steam backend (if using).
    id="Shard_hunter",
    ## Description.
    description=_("Found the secret Nernas Shard."),
    ## The image used in the popup and in the gallery once this achievement
    ## is unlocked.
    unlocked_image="gui/window_icon.png",
    ## By default all achievements use the "locked_achievement" image (declared
...
define Tis_just_a_flesh_wound = Achievement(
    name=_("Tis just a flesh wound (Bronze)"),
    id="Tis just a flesh wound (Bronze)",
    description=_("Receive a scar."),
...
## Example 2 ###################################################################
define Mineralogist = Achievement(
    name=_("Mineralogist (Gold)"),
    id="Mineralogist",
    description=_("Find all the Marked Stones."),
    unlocked_image=Transform("gui/window_icon.png", matrixcolor=InvertMatrix()),
    ## To record progress, you need to specify a stat_max. This means you can
    ## show a progress bar with % completion towards the achievement. It is
    ## useful if, for example, you have an achievement counting how many
...
define -2 all_achievements = Achievement(
    name=_("Nernas' successor (Platinum)"),
